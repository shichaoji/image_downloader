...
def download(ininin):
    ...
    try:
        ...
        print 'try %s again for 20s passed'%name.split('/')[-1]
##        print e
    ...
    try:
        print 'get: ' + str(ininin[0]).split('_')[-2] + '_' + str(ininin[0]).split('_')[-1]\
              +'      |  size:  '+how
...
class ImagePreview:
    def __init__(self, root):
        ...
        self.changeImage('starting.jpg')



        
##        self.imageContainer = Label(self.imageWindow,\
##                                     font=('楷书', 14, 'bold'),fg='magenta'\
##                                           , image=None,text="哎呀我去")
##        self.imageContainer.image=pp
...
##        self.root.resizable(width=False, height=False)
        ...
        self.root.title("咱第一个程序 --Shichao Ji")
        ...
        self.butt1=Button(self.root, text='coser排行榜', command=lambda:webbrowser.open\
            ('http://worldcosplay.net/zh-hans/ranking/member/cosplayer'), \
                  fg='purple', font=('黑体', 16), width=30)
        self.butt1.pack(side='top',anchor='w')




        self.butt2=Button(self.root, text='开始', fg='blue',\
                  font=('宋体', 14, 'normal'), wraplength=1,\
...
##        op0.place(relx=-1, rely=0, relwidth=0.08, relheight=0.43)
        ...
        self.butt3=Button(self.root, text='随机浏览', fg='darkgreen',\
                  font=('宋体', 14, 'normal'), wraplength=1,\
...
##        op1.pack(side='left',anchor='ne')
        ...
        self.butt5=Button(self.root, text='小', fg='hotpink',\
                  font=('宋体', 14, 'normal'), wraplength=1,\
...
##        op1.pack(side='left',anchor='ne')
        ...
        self.butt6=Button(self.root, text='中', fg='mediumvioletred',\
        font=('宋体', 14, 'normal'), wraplength=1,\
        ...
        self.butt7=Button(self.root, text='大', fg='red',\
        font=('宋体', 14, 'normal'), wraplength=1,\
        ...
        self.butt8=Button(self.root, text='闪人', fg='red',\
        font=('宋体', 14, 'normal'), wraplength=1,\
        ...
        self.butt4=Button(self.root, text='打开本地缩略图', fg='orange', \
                  font=('宋体', 16, 'normal'),\
                   command=self.out,width=18)
##        op2.pack(side='right',anchor='n')
        self.butt4.place(relx=.65, rely=0.0)
...
class Husky(pics):
    ...
    def changing(self):
        ...
        try:
            ...
            self.imageWindow.changeImage('starting.jpg')
            print(0)
...
if __name__=='__main__':
    ...
    starting_string=starting.cute()
    starting_image=starting_string.decode('base64')
    gg = open('starting.jpg', "wb")
    gg.write(starting_image)
    gg.close()
